  ...
  return (
    <section className="lights-panel">
      ...
      <div className="light-controls">
        <button className="lights-button" onClick={() => handleButtonClick(1)}>
          1
        </button>
        <button className="lights-button" onClick={() => handleButtonClick(2)}>
          2
        </button>
        <button className="lights-button" onClick={() => handleButtonClick(3)}>
          3
        </button>
        <button className="lights-button" onClick={() => handleButtonClick(4)}>
          4
        </button>
        <button className="lights-button" onClick={() => handleButtonClick(5)}>
          5
        </button>
      </div>
